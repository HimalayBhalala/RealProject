...
class Profile(TimeStampedUUIDMODEL):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"),max_length=30,default="+91123567891")
    about_me = models.TextField(verbose_name=_("About Me"),default = "Say something about youself")
    license = models.CharField(verbose_name=_("Real project Licence"),max_length=20,blank=True,null=True)
    profile_photo = models.ImageField(verbose_name=_("Profile Photo",default= "profile_defult.png"))
    ...
    city = models.CharField(verbose_name=_("City"),max_length=180,default="Surat",blank=False,null=False)
