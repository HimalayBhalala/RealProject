...
class Property(TimeStampedUUIDMODEL):
    ...
    description = models.TextField(verbose_name=_("Desciption"),default = "Default description...update me please...",)
    country = CountryField(verbose_name=_("Country"),default="IN",blank_label = ("select country"),)
    city = models.CharField(verbose_name=_("City"),max_length = 180,default = "Surat")
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=100,default="140")
    street_address = models.CharField(verbose_name = _("Street Address"),max_length=150,default="Reliance Avenue")
    ...
    cover_photo = models.ImageField(verbose_name = _("Main Photo"),null=True,blank=True)
